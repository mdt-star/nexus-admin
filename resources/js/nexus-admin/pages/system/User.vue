  ...
  <div class="nexus-page">
    ...
    <el-card class="nexus-table-card">
      ...
      <el-table :data="users" border stripe v-loading="loading" style="width: 100%" max-height="calc(100vh - 320px)" @selection-change="handleSelectionChange">
        ...
        <el-table-column v-if="columnVisibility.username" prop="username" :label="t('user.username')" min-width="120" />
        <el-table-column v-if="columnVisibility.email" prop="email" :label="t('user.email')" min-width="200" />
        <el-table-column v-if="columnVisibility.role" prop="role" :label="t('user.role')" min-width="120" />
        <el-table-column v-if="columnVisibility.status" prop="status" :label="t('common.status')" min-width="100">
        ...
        <el-table-column v-if="columnVisibility.lastLoginAt" prop="lastLoginAt" label="最后登录" min-width="180" />
        <el-table-column v-if="columnVisibility.createdAt" prop="createdAt" :label="t('common.createdAt')" min-width="180" />
